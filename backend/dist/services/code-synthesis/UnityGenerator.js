...
exports.UnityGenerator = void 0;
const CodeValidator_1 = require("./CodeValidator");
class UnityGenerator {
    constructor() {
        this.templates = new Map();
        this.validator = new CodeValidator_1.CodeValidator();
...
exports.UnityGenerator = UnityGenerator;
