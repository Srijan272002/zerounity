...
class CodeValidator {
    ...
    validateCode(params) {
        ...
        const relevantRules = Array.from(this.rules.values()).filter(rule => rule.engine === engine && rule.language === language);
    ...
    validateUnitySpecifics(code, errors, warnings, suggestions) {
    ...
    validateGodotSpecifics(code, errors, warnings, suggestions) {
